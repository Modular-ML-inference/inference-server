...
do
  ...
  docker cp "./demo-data/test_x_$i.npy" "appv$i-local_operations-1:data/x_test.npy"
  docker cp "./demo-data/test_y_$i.npy" "appv$i-local_operations-1:data/y_test.npy"
done
